...
public class NoteController {
	...
	public ModelAndView index() {
		return new ModelAndView("index","list", noteRepository.getAllNotes());
	}
	...
	public ModelAndView getAllNotes() {
		return new ModelAndView("note", "command", new Note());
	}*/
	...
	*/
	...
	{
		final List<Note> listOfNotes = noteRepository.getAllNotes();
		note.setCreatedAt(LocalDateTime.now());

		listOfNotes.add(note);
		noteRepository.setList(listOfNotes);
	...
	*/
	...
	public RedirectView delete(@RequestParam("noteId") int noteId){
		noteRepository.deleteNote(noteId);
		RedirectView review =  new RedirectView("/");
		review.setUrl("/");
		review.setExposeModelAttributes(false);
		return review;
	}
